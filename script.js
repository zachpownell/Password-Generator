...
function syncCharacterAmount(e) {
    ...
    if (value > 12 && value < 24) {
        strengthDisplay.innerText = "Password Strength: Moderate";
        // strengthDisplay.style.color = "orange"
    } else if (value >= 24) {
        strengthDisplay.innerText = "Password Strength: Strong";
        // strengthDisplay.style.color = "lawngreen"
    } else {
        strengthDisplay.innerText = "Password Strength: Weak";
